...
ace_ventura = media.Movie("Ace Ventura: Pet Detective",
                          "https://upload.wikimedia.org/wikipedia/en/8/84/Ace_ventura_pet_detective.jpg",  # NOQA
                          "https://www.youtube.com/watch?v=QzxDlS6QY1s")
green_mile = media.Movie("The Green Mile",
                         "https://upload.wikimedia.org/wikipedia/en/c/ce/Green_mile.jpg",  # NOQA
...
smith = media.Movie("Mr. & Mrs. Smith",
                    "https://upload.wikimedia.org/wikipedia/en/b/b4/Mr_and_mrs_smith_poster.jpg",  # NOQA
...
button = media.Movie("The Curious Case of Benjamin Button",
                     "https://upload.wikimedia.org/wikipedia/en/7/7d/Curious_case_of_benjamin_button_ver3.jpg",  # NOQA
